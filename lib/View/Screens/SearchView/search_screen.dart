            ...
            return ConditionalBuilder(
              ...
              return  Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: Text('Patients', style: TextStyle(color: thirdColor ,fontSize: 30,fontWeight: FontWeight.bold),),),
                body: Form(
                  key: formkey,
                  child: Padding(
                    ...
                    child: Expanded(
                      child: Column(
                          children: [
                             SizedBox(height: 15,),
                            InputField (Controller:searchCon,
                            ...
                            if(state is ShopLoadingGetPatientsState) LinearProgressIndicator(),

                            if(state is ShopLoadingSearchProductState && cubit.get_data == true) LinearProgressIndicator(),

                            SizedBox(height: 10,),
                            if((state is ShopSuccessSearchProductState && cubit.search_List.length !=0 && cubit.get_data == true) || state is ShopSuccessGetPatientsState || state is ShopSuccessemptySearchProductState) Expanded(
                            ...
                            if(state is ShopSuccessSearchProductState && cubit.search_List.length ==0 && cubit.get_data == true)Expanded(
                              child: Center(
                                  child: Image(
                            ...
                            if(cubit.get_data == false)LinearProgressIndicator(),
